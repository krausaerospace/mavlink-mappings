...
const magicNumbers = {};
function generate(name, obj, output) {
    // ------------------------------------------------------------------------
    // ENUMS
    // ------------------------------------------------------------------------
    var _a;
    // parse XML data
    if ((_a = obj.mavlink.enums[0]) === null || _a === void 0 ? void 0 : _a.enum) {
    ...
    messages.forEach((message) => {
        ...
        const crc = (0, utils_1.x25crc)(buffer);
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < parts.length; i++) {
            ...
            const data = yield parser.parseStringPromise(xml.toString(), { explicitChildren: true, preserveChildrenOrder: true });
