 ...
 */
export declare enum AirspeedsFlags {
    /**
     * 0x01 Airspeed 1 Enabled to Use
     */
    'AIRSPEED1_ENABLED_TO_USE' = 1,
    /**
     ...
     */
    'AIRSPEED1_IS_PRIMARY' = 4,
    /**
     * 0x08 Airspeed 2 Enabled to Use
     */
    'AIRSPEED2_ENABLED_TO_USE' = 8,
    /**
     * 0x10 Airspeed 2 is Healthy
     */
    'AIRSPEED2_HEALTHY' = 16,
    /**
     * 0x20 Airspeed 2 is Primary Sensor
     */
    'AIRSPEED2_IS_PRIMARY' = 32
}
/**
 ...
 * All Airspeeds
 */
export declare class Airspeeds extends MavLinkData {
    static MSG_ID: number;
    static MSG_NAME: string;
    static PAYLOAD_LENGTH: number;
    static MAGIC_NUMBER: number;
    ...
    constructor();
    /**
     * Status flags of the Airspeeds
     */
    flags: AirspeedsFlags;
    /**
     * Vehicle airspeed 1 speed in form appropriate for vehicle type. For standard aircraft this is
    ...
    airspeed1: float;
    /**
     * Vehicle airspeed 2 speed in form appropriate for vehicle type. For standard aircraft this is
     * typically calibrated airspeed (CAS) or indicated airspeed (IAS) - either of which can be used by a
     * pilot to estimate stall speed.
     * Units: m/s
     */
